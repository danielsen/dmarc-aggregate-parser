...
class ParserTestFixture(unittest.TestCase):
    ...
    def test_records(self):
        ...
        self.assertEqual(first_record.indentifiers.header_from, "mail6.acme-company.net")
        self.assertEqual(first_record.indentifiers.envelope_to, None)
        self.assertEqual(first_record.indentifiers.envelope_from, None)
